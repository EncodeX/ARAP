		...
		for (int i = 0; i < itemsCount; i++) {
			...
			item.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					String string="";
					int id=v.getId();
					if(id==R.id.slidingSwitcherView1)
					{
						string="slidingSwitcherView1";
					}
					else if(id==R.id.slidingSwitcherView2)
					{
						string="slidingSwitcherView2";
					}
					else if(id==R.id.slidingSwitcherView3)
					{
						string="slidingSwitcherView3";
					}
					else
					{
						string="slidingSwitcherView4";
					}
					Toast.makeText(v.getContext(),"haha"+ string,Toast.LENGTH_SHORT).show();
				}
			});
		}
