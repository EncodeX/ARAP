...
//    __android_log_print(ANDROID_LOG_INFO, "EasyAR", "[");
//    for(int i=0; i<4; ++i){
//        __android_log_print(ANDROID_LOG_INFO, "EasyAR", "  %f %f %f %f", camera_data[i*4], camera_data[i*4+1], camera_data[i*4+2], camera_data[i*4+3]);
//    }
//    __android_log_print(ANDROID_LOG_INFO, "EasyAR", "]");
